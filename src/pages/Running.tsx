...
import { Footprints, Save, Play, Pause } from "lucide-react";
...
const Running = () => {
  ...
  const saveSession = () => {
    ...
    toast({
      title: "Run saved!",
      description: `${distance}km run logged successfully`,
    });
      ...
      <div className="max-w-lg mx-auto p-4 space-y-6">
        ...
        <div className="pt-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Track your runs</p>
            </div>
          </div>
        </div>

        {/* GPS Tracking Card */}
        <Card className="p-6 border-success/30 bg-gradient-to-br from-success/10 to-transparent">
          <div className="text-center space-y-4">
            <div className="w-20 h-20 mx-auto rounded-full bg-success/20 flex items-center justify-center">
              {isTracking ? (
                <Pause className="w-10 h-10 text-success animate-pulse" />
              ) : (
        ...
        <div>
          ...
          <Card className="p-8 text-center border-dashed">
            <Footprints className="w-12 h-12 mx-auto mb-3 text-muted-foreground" />
            <p className="text-muted-foreground">No runs yet</p>
            <p className="text-sm text-muted-foreground mt-1">Start tracking to see your runs here</p>
          </Card>
        </div>
      </div>
